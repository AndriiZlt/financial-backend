...
public class AlpacaController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAssets()
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetAssets controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> GetAsset(string assetId)
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetAsset controller. {@ex}", ex.Message);
            return BadRequest("Something went wrong");
        }
    }
    ...
    public async Task<IActionResult> GetPositions()
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetPositions controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> ClosePosition(string asset_id)
    {
        ...
        {
            Log.Error("An unexpected error occurred in ClosePosition controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> GetMonthBars(string symbol)
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetMonthBars controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> GetAccount()
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetAccount controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> GetOrders()
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetOrders controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> CreateOrder(OrderDTO order)
    {
        ...
        {
            Log.Error("An unexpected error occurred in CreateOrder controller. {@ex}", ex.Message);
    ...
    public async Task<IActionResult> GetTrades(string symbol)
    {
        ...
        {
            Log.Error("An unexpected error occurred in GetTrades controller. {@ex}", ex.Message);
            return BadRequest("Something went wrong");
        }
    }
